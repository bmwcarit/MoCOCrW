...
void VerificationTest::SetUp()
{
    ...
    _root3_invalidCrl = std::make_unique<CertificateRevocationList>(
            loadCrlFromFile("root3.crl_invalidsignature.pem"));
    _root3_emptycrl =
            std::make_unique<CertificateRevocationList>(loadCrlFromFile("root3.crl_empty.pem"));
    _root3_expiredcrl =
            std::make_unique<CertificateRevocationList>(loadCrlFromFile("root3.crl_expired.pem"));
    _root3_int1 = std::make_unique<X509Certificate>(loadCertFromFile("root3.int1.pem"));
    _root3_int1_crl =
            std::make_unique<CertificateRevocationList>(loadCrlFromFile("root3.int1.crl.pem"));
    _root3_int1_emptycrl = std::make_unique<CertificateRevocationList>(
            loadCrlFromFile("root3.int1.crl_empty.pem"));
    _root3_int1_otherEntryCrl = std::make_unique<CertificateRevocationList>(
            loadCrlFromFile("root3.int1.crl_otherentry.pem"));
    _root3_int1_int11 = std::make_unique<X509Certificate>(loadCertFromFile("root3.int1.int11.pem"));
    _root3_int1_int11_emptycrl = std::make_unique<CertificateRevocationList>(
            loadCrlFromFile("root3.int1.int11.crl_empty.pem"));
    _root3_int1_cert12 =
            std::make_unique<X509Certificate>(loadCertFromFile("root3.int1.cert12.pem"));
    ...
    _eccExpiredCert =
            std::make_unique<X509Certificate>(loadCertFromFile("eccExpiredcertificate.pem"));
...
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_root1_expired.get()).setVerificationCheckTime(Asn1Time::now());
...
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_root1.get()).setVerificationCheckTime(Asn1Time::now());
...
TEST_F(VerificationTest, testCompleteChainVerificationFailsWithWrongRoot)
{
    ...
    std::vector<X509Certificate> intermediateCAs{
            *_root1.get(), *_root1_int1.get(), *_root1_int1_int11.get()};
...
TEST_F(VerificationTest, testVerificationWorksWithUnusedElementsInChainParam)
{
    std::vector<X509Certificate> trustStore{*_root1.get()};
    std::vector<X509Certificate> intermediateCAs{
            *_root1_int1_int11.get(), *_root1_int1.get(), *_root1_int2.get()};
...
TEST_F(VerificationTest, testVerificationWorksWithUnusedElementsInChainParamEcc)
{
    std::vector<X509Certificate> trustStore{*_eccRoot.get()};
    std::vector<X509Certificate> intermediateCAs{
            *_eccIntermediate.get(), *_root1_int1.get(), *_root1_int2.get()};
...
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_root1_int1.get()).enforceSelfSignedRootCertificate();
...
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_eccIntermediate.get()).enforceSelfSignedRootCertificate();
...
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_root3.get()).addCertificateRevocationList(*_root3_emptycrl.get());
    ASSERT_NO_THROW(_root3_int1->verify(ctx));
}
...
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_root3.get()).addCertificateRevocationList(*_root3_invalidCrl.get());
    ASSERT_THROW(_root3_int1->verify(ctx), MoCOCrWException);
}
...
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_root3.get()).addCertificateRevocationList(*_root3_expiredcrl.get());
    ASSERT_THROW(_root3_int1->verify(ctx), MoCOCrWException);
}
...
MATCHER(PemEq, "") { return std::get<0>(arg).toPEM() == std::get<1>(arg).toPEM(); }
...
TEST_F(VerificationTest,
       testVerificationContextWithCrlCheckAllWithoutSelfSignedRootOrCrlsIsNotValid)
{
    VerificationContext ctx;
    ctx.addTrustedCertificate(*_root3.get())
            .addIntermediateCertificate(*_root3.get())
