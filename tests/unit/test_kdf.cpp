...
static std::vector<inputData> prepareTestDataForPbkdf2Tests()
{
    std::vector<inputData> testData {
        ...
        },
        {
            ...
            1,
            64,
            "867f70cf1ade02cff3752599a3a53dc4af34c7a669815ae5d513554e1c8cf252c02d470a285a0501bad999bfe943c08f050235d7d68b"
        ...
        },
        {
            ...
            4096,
            64,
            "d197b1b33db0143e018b12f3d1d1479e6cdebdcc97c5c0f87f6902e072f457b5143f30602641b3d55cd335988cb36b84376060ecd532"
...
INSTANTIATE_TEST_CASE_P(pbkdf2,
                        Pbkdf2Tests,
                        testing::ValuesIn(prepareTestDataForPbkdf2Tests()));

TEST_P(Pbkdf2Tests, tests)
{
    testPbkfd2(GetParam());
}
...
static std::vector<inputData> prepareTestDataForX963Tests()
{
    ...
    std::vector<inputData> testData {
        ...
        },
        {
            ...
            0,
            1024 / 8,
            "c498af77161cc59f2962b9a713e2b215152d139766ce34a776df11866a69bf2e52a13d9c7c6fc878c50c5ea0bc7b00e0da2447cfd8"
            "74f6cf92f30d0097111485500c90c3af8b487872d04685d14c8d1dc8d7fa08beb0ce0ababc11f0bd496269142d43525a78e5bc79a1"
        ...
        },
        {
            ...
            0,
            1024 / 8,
            "cf6a84434734ac6949e1d7976743277be789906908ad3ca3a8923da7f476abbeb574306d7243031a85566914bfd247d2519c479953d"
            "9d55b6b831e56260806c39af21b74e3ecf470e3bd8332791c8a23c13352514fdef00c2d1a408ba31b2d3f9fdcb373895484649a645d"
        ...
        {
            openssl::DigestTypes::SHA512,
            utility::fromHex("00aa5bb79b33e389fa58ceadc047197f14e73712f452caa9fc4c9adb369348b81507392f1a86ddfdb7c4ff8231"
                             "c4bd0f44e44a1b55b1404747a9e2e753f55ef05a2d"),
            utility::fromHex("e3b5b4c1b0d5cf1d2b3a2f9937895d31"),
            0,
            1024 / 8,
            "4463f869f3cc18769b52264b0112b5858f7ad32a5a2d96d8cffabf7fa733633d6e4dd2a599acceb3ea54a6217ce0b50eef4f6b40a5c"
            "30250a5a8eeee208002267089dbf351f3f5022aa9638bf1ee419dea9c4ff745a25ac27bda33ca08bd56dd1a59b4106cf2dbbc0ab2aa"
...
INSTANTIATE_TEST_CASE_P(x9_63,
                        X963Tests,
                        testing::ValuesIn(prepareTestDataForX963Tests()));

TEST_P(X963Tests, tests)
{
    testX963kdf(GetParam());
}
