...
Hash Hash::fromDigestType(const openssl::DigestTypes digestType) { return Hash(digestType); }

const std::map<DigestTypes, size_t> Hash::lengthInBytes = {{DigestTypes::SHA1, 160 / 8},
...
Hash Hash::sha1() { return Hash{DigestTypes::SHA1}; }

Hash Hash::sha256() { return Hash{DigestTypes::SHA256}; }

Hash Hash::sha384() { return Hash{DigestTypes::SHA384}; }

Hash Hash::sha512() { return Hash{DigestTypes::SHA512}; }

Hash Hash::sha3_256() { return Hash{DigestTypes::SHA3_256}; }

Hash Hash::sha3_384() { return Hash{DigestTypes::SHA3_384}; }

Hash Hash::sha3_512() { return Hash{DigestTypes::SHA3_512}; }
...
Hash &Hash::update(const std::vector<uint8_t> &chunk) { return update(chunk.data(), chunk.size()); }
