...
public:
    ...
    BasicConstraintsExtension(bool ca, int pathlength) : _ca{ca}, _pathlength{pathlength} {}

    BasicConstraintsExtension() : _ca{false}, _pathlength{0} {}

    /**
     * @return true if the signed certificate may be used for signing other certificates.
     */
    bool isCA() const { return _ca; }
    ...
    bool operator!=(const BasicConstraintsExtension &other) const { return !operator==(other); }
